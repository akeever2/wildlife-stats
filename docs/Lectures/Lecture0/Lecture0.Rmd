...
author: "<br/><br/><br/>BIOL 6980 (Spring 2020)"
output:
...
#### [Dr. Allison Keever](https://ackeeve.netlify.app/)  
...
Refer to [syllabus](https://akeever2.github.io/wildlife-stats/syllabus.html)
...
####Science is a search for truth through accumulation of facts   
--
- Truth - the way things really are, **never known**  
--
- Facts - measurement of observed state, estimate of truth, **DISPUTABLE**  
--


.pull-left[
#### Statistics will always give you  

1) Estimate of truth  
2) Estimate of uncertainty  
]
--
.pull-right[
#### 2 reasons you can never know truth  

1) There will always be some measurement error  
2) Sampling or process error, usually only taking a sample of the population  
]
---
## Why Bayesian?
